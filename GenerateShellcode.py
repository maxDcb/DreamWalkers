...
class Instance:
    def __init__(self, moduleSize, isDll, sdllMethode, isDotNet, dotnetLoaderSize, dotnetModuleSize, args="", exit_mode=1):
        ...
        self.sAddVectoredExceptionHandler = b"RtlAddVectoredExceptionHandler".ljust(32, b"\x00")
        self.sRemoveVectoredExceptionHandler = b"RtlRemoveVectoredExceptionHandler".ljust(64, b"\x00")
